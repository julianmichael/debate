...
object DebatePage {
  ...
  def make(profiles: Set[String], connectionSpec: ConnectionSpec, disconnect: Callback) = {
                  ...
                  setup
                    ...
                    .toVdomArray { case (answer, answerIndex) =>
                      ...
                      <.div(
                        ...
                        S.simpleSelectable.when(setup.canAssumeRole(userName, Debater(answerIndex)))
                      )(
