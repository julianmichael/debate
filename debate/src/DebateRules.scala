...
/**
  * Rules of the debate.
  * I expect to want to add more stuff here as we want to vary the debates on different dimensions.
  *
  * @param fixedOpening the structure of the opening rounds of the debate
  * @param repeatingStructure the structure to repeat indefinitely after the opening rounds
  * @param scoringFunction the scoring function to used in reward calculations
  */
@Lenses @JsonCodec case class DebateRules(
  ...
  /**
    * Schematic for the turns that the debate will follow.
    * This will be compared to the actual turn sequence to decide whose turn it is.
    * Each 'round' (eg SequentialSpeechesRound) needs to be expanded to its sequence of 'turns'
    * (eg sequence of DebaterSpeechTurn).
    *
    * @param numDebaters the number of different answers being argued for / debaters arguing
    */
