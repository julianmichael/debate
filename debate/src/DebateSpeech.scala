...
/**
  ...
  *
  * @param speaker the ID of the debater who wrote the speech.
  * @param timestamp millis from epoch from which the speech was written.
  * @param content the debater's argument
  */
...
/** Segment of a single contiguous argument by a debater.
  * Can be free text (Text) or evidence (Quote).
  * We could potentially incorporate other types of evidence or content later
